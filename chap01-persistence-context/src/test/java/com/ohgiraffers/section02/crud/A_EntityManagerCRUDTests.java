...
public class A_EntityManagerCRUDTests {
    ...
    @Test
    public void selectMenuByCodeTest() {
        ...
        Menu menu2 = entityManager.find(Menu.class, 4);
    ...
    public void insertNewMenuTest() {
        ...
        // then
        Assertions.assertTrue(entityManager.contains(menu)); // 영속성 컨텍스트에 menu가 있는지 확인
    }
